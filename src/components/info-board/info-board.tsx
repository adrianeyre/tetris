	...
	return (
		<div className="info-board" style={styleInfoBoard()}>
			...
			<div className="info-board-instructions">
				<p>
					You have to make full horizontal lines with the different shaped blocks that fall into the game area. Full lines will
					then disappear and provide points. The more lines you make at the same time, the more points you earn.
				</p>
			</div>
