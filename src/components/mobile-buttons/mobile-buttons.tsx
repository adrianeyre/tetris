	...
	return (
		<div className="mobile-buttons">
			<div className="button-row">
				<button className="left-button" type="button" onClick={() => props.handleMobileButton(PlayerResultEnum.ARROW_LEFT)}>
					LEFT
				</button>
			...
			<div className="button-row">
				<button className="left-button" type="button" onClick={() => props.handleMobileButton(PlayerResultEnum.SPACE_BAR)}>
					SPIN
				</button>
